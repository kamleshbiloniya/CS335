...
#         for x in range(len(p[1].idList)):
#             p[0].code = [['push', '', '', p[1].placeList[x]]] + p[0].code
#         for x in range(len(p[1].idList)):
#             info = findInfo(p[1].idList[x])
#             print ("poppppp",p[1].placeList)
#             p[0].code = [['pop', '', len(p[1].idList) - x +1, p[1].placeList[x]]] + p[0].code
...
def p_func(p):
    ...
    try:
        ...
        temp_code = []
        temp_list = []
        print "During function Definition execution: "
        for x in range(len(p[1].idList)):
        ...
        print "--------------------------------------------------"
        print "Inside Function Definition: scope is : ", currScope
        print "Lets see the symbol table of this Function: "
        for n in scopeDict[currScope].table:
            print n, ":", scopeDict[currScope].table[n]
        print "--------------------------------------------------\n"
...
def p_expr(p):
    ...
    try:
        if len(p) == 4:
            p[0] = Node()
            print("Expression: arithmetic operations!")
            ...
            if p[2] == '+':
                if p[1].typeList[0]=='int' and p[3].typeList[0]=='int':
                    ...
                    if(len(p[1].valueList) and len(p[3].valueList)):
                        #  Both the values are available during compile time. We can optimise the 3AC-code!
                        answer = p[1].valueList[0] + p[3].valueList[0]
                        p[0].valueList.append(answer)
                        scopeDict[scope].updateArgList(p[0].placeList[0], 'value', answer)
                        p[0].code.append([p[0].placeList[0], ' ', '=', p[0].valueList[0]])
                    else:
                        # Values not available at the run time.
                    ...
                    if(len(p[1].valueList) and len(p[3].valueList)):
                        # String concatenation not done at compile time - we are not storing the strings.
                        p[0].valueList.append(p[1].valueList[0] + p[3].valueList[0])
                    p[0].code.append([p[0].placeList[0],p[1].placeList[0],'+',p[3].placeList[0] ])
                    scopeDict[scope].updateArgList(p[0].placeList[0], 'value', p[3].valueList[0])
                elif (p[1].typeList[0]=='float' and p[3].typeList[0]=='float'):
                    p[0].typeList = ['float']
                    if(len(p[1].valueList) and len(p[3].valueList)):
                        p[0].valueList.append(p[1].valueList[0] + p[3].valueList[0])
                    p[0].code.append([p[0].placeList[0],p[1].placeList[0],'+',p[3].placeList[0] ])
                ...
                if p[1].typeList[0]=='int' and p[3].typeList[0]=='int':
                    ...
                    if(len(p[1].valueList) and len(p[3].valueList)):
                        answer = p[1].valueList[0] - p[3].valueList[0]
                        p[0].valueList.append(answer)
                        p[0].code.append([p[0].placeList[0], ' ', '=', answer])
                        scopeDict[scope].updateArgList(p[0].placeList[0], 'value', answer)
                    else:
                        p[0].code.append([p[0].placeList[0],p[1].placeList[0],'-',p[3].placeList[0] ])
                elif (p[1].typeList[0]=='float' and p[3].typeList[0]=='float'):
                ...
                if p[1].typeList[0]=='int' and p[3].typeList[0]=='int':
                    ...
                    if(len(p[1].valueList) and len(p[3].valueList)):
                        answer = p[1].valueList[0] / p[3].valueList[0]
                        p[0].valueList.append(answer)
                        p[0].code.append([p[0].placeList[0],p[1].placeList[0],'/',answer ])
                        scopeDict[scope].updateArgList(p[0].placeList[0], 'value', answer)
                    else:
                        p[0].code.append([p[0].placeList[0],p[1].placeList[0],'/',p[3].placeList[0] ])
                    # p[0].valuelist = ([p[1].valuelist[0]*p[3].valuelist[0]]) if p[2]=='*' else ([p[1].valuelist[0]/p[3].valuelist[0]])
                ...
                scopeDict[scope].updateArgList(p[0].placeList[0], 'value', p[3].valueList[0])
                scopeDict[scope].updateArgList(p[0].placeList[0], 'type', "bool")
                print("condition == end",p[3].placeList[0])
            ...
            p[0] = p[1]
            # print("in expressions",p[1].extra)
        pass
    except Exception as e:
        print("WARNING:23:"+str(e))
        return
...
def p_print_stmt(p):
    ...
    try:
        ...
        if p[2].typeList[0].startswith('lit'):
            t = p[2].typeList[0][3:]
        else:
            t = p[2].typeList[0]
        if t == 'int':
            p[0].code.append(['printint', ' ', ' ', p[2].placeList[0]])
        else:
